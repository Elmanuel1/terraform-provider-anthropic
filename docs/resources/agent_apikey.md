...
Use this resource when you have a static workspace API key. For Terraform Cloud workspaces using OIDC federation, use [`anthropic_wif_agent`](agent.md) instead.
